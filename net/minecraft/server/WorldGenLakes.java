        ...
        for (int j1 = 0; j1 < 16; j1++) {
            for (int l2 = 0; l2 < 16; l2++) {
                for (int k3 = 0; k3 < 8; k3++) {
                    boolean flag = !aflag[(j1 * 16 + l2) * 8 + k3] && (j1 < 15 && aflag[((j1 + 1) * 16 + l2) * 8 + k3] || j1 > 0 && aflag[((j1 - 1) * 16 + l2) * 8 + k3] || l2 < 15 && aflag[(j1 * 16 + (l2 + 1)) * 8 + k3] || l2 > 0 && aflag[(j1 * 16 + (l2 - 1)) * 8 + k3] || k3 < 7 && aflag[(j1 * 16 + l2) * 8 + (k3 + 1)] || k3 > 0 && aflag[(j1 * 16 + l2) * 8 + (k3 - 1)]);
