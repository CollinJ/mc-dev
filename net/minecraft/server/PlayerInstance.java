...
class PlayerInstance {
    ...
    public PlayerInstance(PlayerManager playermanager, int i1, int j1) {
        ...
        PlayerManager.a(playermanager).e.y.d(i1, j1);
    }
    ...
    public void b(EntityPlayerMP entityplayermp) {
        ...
        if (b.size() == 0) {
            ...
            PlayerManager.a(a).e.y.c(c, d);
        }
        entityplayermp.ag.remove(((e)));
        if (entityplayermp.ah.contains(((e)))) {
    ...
    public void a() {
        ...
        if (g == 1) {
            ...
            a(((Packet) (new Packet51MapChunk(j1, i2, l2, j3, l3, i4, ((World) (PlayerManager.a(a).e))))));
            ...
            a(((Packet) (new Packet52MultiBlockChange(c, d, f, g, ((World) (PlayerManager.a(a).e))))));
