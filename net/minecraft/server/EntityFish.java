...
public class EntityFish extends Entity {
    ...
    public void b_() {
        ...
        if (!this.l.z) {
            ...
            if (b.F || !b.w() || itemstack == null || itemstack.a() != Item.aP || b(((Entity) (b))) > 1024D) {
                l();
                b.at = null;
                return;
            }
        ...
        if (movingobjectposition != null) {
            if (movingobjectposition.g != null) {
                if (movingobjectposition.g.a(((Entity) (b)), 0)) {
        ...
        if (d8 > 0.0D) {
            if (am > 0) {
                ...
                this.l.a(((Entity) (this)), "random.splash", 0.25F, 1.0F + (V.nextFloat() - V.nextFloat()) * 0.4F);
