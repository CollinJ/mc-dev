...
public class NetServerHandler extends NetHandler implements ICommandListener {
    ...
    public void c(String s) {
        ...
        b.c();
        d.f.a(((Packet) (new Packet3Chat((new StringBuilder()).append("\247e").append(e.as).append(" left the game.").toString()))));
        d.f.c(e);
        c = true;
    }
    ...
    public void d() {
        b.a(((Packet) (new Packet5PlayerInventory(-1, e.al.a))));
        b.a(((Packet) (new Packet5PlayerInventory(-2, e.al.c))));
        b.a(((Packet) (new Packet5PlayerInventory(-3, e.al.b))));
    }
