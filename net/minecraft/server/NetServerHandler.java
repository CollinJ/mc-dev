...
public class NetServerHandler extends NetHandler implements ICommandListener {
    ...
    public void a(Packet10Flying packet10flying) {
        ...
        if (j) {
            ...
            double d8 = d4 - e.r;
            float f3 = 0.0625F;
            boolean flag = d.e.a(((Entity) (e)), e.z.b().e(f3, f3, f3)).size() == 0;
            ...
            e.b(d2, d3, d4, f1, f2);
            boolean flag2 = d.e.a(((Entity) (e)), e.z.b().e(f3, f3, f3)).size() == 0;
    ...
    public void d() {
        b.a(((Packet) (new Packet5PlayerInventory(-1, e.ak.a))));
        b.a(((Packet) (new Packet5PlayerInventory(-2, e.ak.c))));
        b.a(((Packet) (new Packet5PlayerInventory(-3, e.ak.b))));
    }
