...
public class NetServerHandler extends NetHandler implements ICommandListener {
    ...
    public void c(String s) {
        ...
        b.c();
        d.f.a(((Packet) (new Packet3Chat((new StringBuilder()).append("\247e").append(e.at).append(" left the game.").toString()))));
        d.f.c(e);
        c = true;
    }
    ...
    public void a(Packet15Place packet15place) {
        ...
        if (packet15place.e == 255) {
            ...
            if (i2 > 16 || flag) {
                ...
                e.c.a(((EntityPlayer) (e)), ((World) (d.e)), itemstack1, l, i1, j1, k1);
            }
            e.a.b(((Packet) (new Packet53BlockChange(l, i1, j1, ((World) (d.e))))));
            if (k1 == 0) {
                i1--;
    ...
    public void a(Packet16BlockItemSwitch packet16blockitemswitch) {
        ...
        e.am.a[e.am.d] = k;
        d.k.a(((Entity) (e)), ((Packet) (new Packet16BlockItemSwitch(e.g, l))));
    }
    ...
    public void d() {
        b.a(((Packet) (new Packet5PlayerInventory(-1, e.am.a))));
        b.a(((Packet) (new Packet5PlayerInventory(-2, e.am.c))));
        b.a(((Packet) (new Packet5PlayerInventory(-3, e.am.b))));
    }
