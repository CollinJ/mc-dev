...
public class EntityLiving extends Entity {
    ...
    public void b(NBTTagCompound nbttagcompound) {
        aR = ((int) (nbttagcompound.c("Health")));
        if (!nbttagcompound.a("Health")) {
            aR = 10;
        }
        aT = ((int) (nbttagcompound.c("HurtTime")));
        aW = ((int) (nbttagcompound.c("DeathTime")));
        aX = ((int) (nbttagcompound.c("AttackTime")));
    }
    ...
    public void E() {
        if (bg > 0) {
            ...
            v += ((float) (d4 / (double) bg));
            w += ((float) ((bl - (double) w) / (double) bg));
            bg--;
            a(d1, d2, d3);
            b(v, w);
        }
