...
public class EntityLiving extends Entity {
    ...
    public void m() {
        ...
        if (W.nextInt(1000) < a++) {
            ...
            if (s1 != null) {
                l.a(((Entity) (this)), s1, h(), (W.nextFloat() - W.nextFloat()) * 0.2F + 1.0F);
            }
        }
        if (x() && y()) {
            a(((Entity) (null)), 1);
    ...
    public boolean a(Entity entity, int j) {
        ...
        if (aQ <= 0) {
            if (flag) {
                l.a(((Entity) (this)), f(), h(), (W.nextFloat() - W.nextFloat()) * 0.2F + 1.0F);
            }
            f(entity);
        } else if (flag) {
            l.a(((Entity) (this)), e(), h(), (W.nextFloat() - W.nextFloat()) * 0.2F + 1.0F);
        }
        return true;
    }
    ...
    public void b(NBTTagCompound nbttagcompound) {
        aQ = ((int) (nbttagcompound.c("Health")));
        if (!nbttagcompound.a("Health")) {
            aQ = 10;
        }
        aS = ((int) (nbttagcompound.c("HurtTime")));
        aV = ((int) (nbttagcompound.c("DeathTime")));
        aW = ((int) (nbttagcompound.c("AttackTime")));
    }
    ...
    public void E() {
        if (bf > 0) {
            ...
            v += ((float) (d4 / (double) bf));
            w += ((float) ((bk - (double) w) / (double) bf));
            bf--;
            a(d1, d2, d3);
            b(v, w);
        }
