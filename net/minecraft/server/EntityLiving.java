...
public class EntityLiving extends Entity {
    ...
    public void m() {
        ...
        if (V.nextInt(1000) < a++) {
            ...
            if (s1 != null) {
                l.a(((Entity) (this)), s1, h(), (V.nextFloat() - V.nextFloat()) * 0.2F + 1.0F);
            }
        }
        if (w() && x()) {
            a(((Entity) (null)), 1);
    ...
    public void I() {
        for (int j = 0; j < 20; j++) {
            ...
            l.a("explode", (p + (double) (V.nextFloat() * H * 2.0F)) - (double) H - d1 * d4, (q + (double) (V.nextFloat() * I)) - d2 * d4, (r + (double) (V.nextFloat() * H * 2.0F)) - (double) H - d3 * d4, d1, d2, d3);
        }
    }
    ...
    public boolean a(Entity entity, int j) {
        ...
        if (aP <= 0) {
            if (flag) {
                l.a(((Entity) (this)), f(), h(), (V.nextFloat() - V.nextFloat()) * 0.2F + 1.0F);
            }
            f(entity);
        } else if (flag) {
            l.a(((Entity) (this)), e(), h(), (V.nextFloat() - V.nextFloat()) * 0.2F + 1.0F);
        }
        return true;
    }
    ...
    protected void a(float f1) {
        ...
        if (j > 0) {
            ...
            if (k > 0) {
                ...
                l.a(((Entity) (this)), stepsound.c(), stepsound.a() * 0.5F, stepsound.b() * 0.75F);
            }
        }
    }
    ...
    public void b(NBTTagCompound nbttagcompound) {
        aP = ((int) (nbttagcompound.c("Health")));
        if (!nbttagcompound.a("Health")) {
            aP = 10;
        }
        aR = ((int) (nbttagcompound.c("HurtTime")));
        aU = ((int) (nbttagcompound.c("DeathTime")));
        aV = ((int) (nbttagcompound.c("AttackTime")));
    }
    ...
    public void D() {
        if (be > 0) {
            ...
            v += ((float) (d4 / (double) be));
            w += ((float) ((bj - (double) w) / (double) be));
            be--;
            a(d1, d2, d3);
            b(v, w);
        }
    ...
    protected void c() {
        ...
        if (c != null) {
            b(c, 10F);
            if (d-- <= 0 || c.F || c.b(((Entity) (this))) > (double) (f1 * f1)) {
                c = null;
            }
        } else {
