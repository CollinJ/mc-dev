...
public class EntityLiving extends Entity {
    ...
    public void b(NBTTagCompound nbttagcompound) {
        ba = ((int) (nbttagcompound.c("Health")));
        if (!nbttagcompound.a("Health")) {
            ba = 10;
        }
        bc = ((int) (nbttagcompound.c("HurtTime")));
        bf = ((int) (nbttagcompound.c("DeathTime")));
        bg = ((int) (nbttagcompound.c("AttackTime")));
    }
    ...
    public void G() {
        if (bp > 0) {
            ...
            v += ((float) (d4 / (double) bp));
            w += ((float) ((bu - (double) w) / (double) bp));
            bp--;
            a(d1, d2, d3);
            b(v, w);
        }
