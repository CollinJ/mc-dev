...
public class NetworkManager {
    ...
    public NetworkManager(Socket socket, String s1, NetHandler nethandler) {
        e = new Object();
        j = true;
        k = Collections.synchronizedList(((List) (new ArrayList())));
        l = Collections.synchronizedList(((List) (new ArrayList())));
        m = Collections.synchronizedList(((List) (new ArrayList())));
        o = false;
        r = false;
        s = "";
        u = 0;
        ...
        q = ((Thread) (new NetworkReaderThread(this, (new StringBuilder()).append(s1).append(" read thread").toString())));
        p = ((Thread) (new NetworkWriterThread(this, (new StringBuilder()).append(s1).append(" write thread").toString())));
        q.start();
        p.start();
    }
