...
public class NetworkManager {
    ...
    public NetworkManager(Socket socket, String s1, NetHandler nethandler) {
        d = new Object();
        i = true;
        j = Collections.synchronizedList(((List) (new ArrayList())));
        ...
        p = ((Thread) (new NetworkReaderThread(this, (new StringBuilder()).append(s1).append(" read thread").toString())));
        o = ((Thread) (new NetworkWriterThread(this, (new StringBuilder()).append(s1).append(" write thread").toString())));
        p.start();
        o.start();
    }
