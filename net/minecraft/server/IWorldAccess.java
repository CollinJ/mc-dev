...
public interface IWorldAccess {
    ...
    public abstract void a(String s, double d, double d1, double d2, float f, float f1);

    public abstract void a(String s, double d, double d1, double d2, double d3, double d4, double d5);
