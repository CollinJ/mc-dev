...
public class EntityGhast extends EntityFlying implements IMobs {
    ...
    protected void c() {
        ...
        if (ai == null || aj-- <= 0) {
            ai = ((Entity) (l.a(((Entity) (this)), 100D)));
            if (ai != null) {
                aj = 20;
            }
        }
        ...
        if (ai != null && ai.b(((Entity) (this))) < d5 * d5) {
            double d6 = ai.p - p;
            ...
            if (g(ai)) {
                if (f == 10) {
                    l.a(((Entity) (this)), "mob.ghast.charge", h(), (V.nextFloat() - V.nextFloat()) * 0.2F + 1.0F);
                }
                f++;
                if (f == 20) {
                    l.a(((Entity) (this)), "mob.ghast.fireball", h(), (V.nextFloat() - V.nextFloat()) * 0.2F + 1.0F);
