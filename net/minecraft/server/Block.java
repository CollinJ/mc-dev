...
public class Block {
    ...
    public MovingObjectPosition a(World world, int i1, int j1, int k1, Vec3D vec3d, Vec3D vec3d1) {
        ...
        return new MovingObjectPosition(i1, j1, k1, ((int) (byte0)), vec3d8.c(i1, j1, k1));
    }
    ...
    static {
        ...
        j = ((StepSound) (new StepSoundStone("stone", 1.0F, 1.0F)));
        k = new StepSound("cloth", 1.0F, 1.0F);
        l = ((StepSound) (new StepSoundSand("sand", 1.0F, 1.0F)));
        m = new Block[256];
        ...
        A = (new BlockFlowing(8, Material.f)).c(100F).e(3).a("water");
        B = (new BlockStationary(9, Material.f)).c(100F).e(3).a("water");
        C = (new BlockFlowing(10, Material.g)).c(0.0F).a(1.0F).e(255).a("lava");
        D = (new BlockStationary(11, Material.g)).c(100F).a(1.0F).e(255).a("lava");
        ...
        K = (BlockLeaves) (new BlockLeaves(18, 52)).c(0.2F).e(1).a(g).a("leaves");
        ...
        ah = (new BlockOreBlock(41, 23)).c(3F).b(10F).a(i).a("blockGold");
        ai = (new BlockOreBlock(42, 22)).c(5F).b(10F).a(i).a("blockIron");
        ...
        ax = (new BlockOreBlock(57, 24)).c(5F).b(10F).a(i).a("blockDiamond");
        ...
        aK = (new BlockPressurePlate(70, t.bh, EnumMobType.b)).c(0.5F).a(h).a("pressurePlate");
        aL = (new BlockDoor(71, Material.e)).c(5F).a(i).a("doorIron");
        aM = (new BlockPressurePlate(72, x.bh, EnumMobType.a)).c(0.5F).a(e).a("pressurePlate");
        ...
        aR = (new BlockButton(77, t.bh)).c(0.5F).a(h).a("button");
        aS = (new BlockSnow(78, 66)).c(0.1F).a(k).a("snow");
        aT = (new BlockIce(79, 67)).c(0.5F).e(3).a(j).a("ice");
