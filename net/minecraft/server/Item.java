...
public class Item {
    ...
    static {
        d = (new ItemSpade(0, EnumToolMaterial.c)).a(2, 5).a("shovelIron");
        e = (new ItemPickaxe(1, EnumToolMaterial.c)).a(2, 6).a("pickaxeIron");
        f = (new ItemAxe(2, EnumToolMaterial.c)).a(2, 7).a("hatchetIron");
        o = (new ItemSword(11, EnumToolMaterial.c)).a(2, 4).a("swordIron");
        p = (new ItemSword(12, EnumToolMaterial.a)).a(0, 4).a("swordWood");
        q = (new ItemSpade(13, EnumToolMaterial.a)).a(0, 5).a("shovelWood");
        r = (new ItemPickaxe(14, EnumToolMaterial.a)).a(0, 6).a("pickaxeWood");
        s = (new ItemAxe(15, EnumToolMaterial.a)).a(0, 7).a("hatchetWood");
        t = (new ItemSword(16, EnumToolMaterial.b)).a(1, 4).a("swordStone");
        u = (new ItemSpade(17, EnumToolMaterial.b)).a(1, 5).a("shovelStone");
        v = (new ItemPickaxe(18, EnumToolMaterial.b)).a(1, 6).a("pickaxeStone");
        w = (new ItemAxe(19, EnumToolMaterial.b)).a(1, 7).a("hatchetStone");
        x = (new ItemSword(20, EnumToolMaterial.d)).a(3, 4).a("swordDiamond");
        y = (new ItemSpade(21, EnumToolMaterial.d)).a(3, 5).a("shovelDiamond");
        z = (new ItemPickaxe(22, EnumToolMaterial.d)).a(3, 6).a("pickaxeDiamond");
        A = (new ItemAxe(23, EnumToolMaterial.d)).a(3, 7).a("hatchetDiamond");
        E = (new ItemSword(27, EnumToolMaterial.e)).a(4, 4).a("swordGold");
        F = (new ItemSpade(28, EnumToolMaterial.e)).a(4, 5).a("shovelGold");
        G = (new ItemPickaxe(29, EnumToolMaterial.e)).a(4, 6).a("pickaxeGold");
        H = (new ItemAxe(30, EnumToolMaterial.e)).a(4, 7).a("hatchetGold");
        L = (new ItemHoe(34, EnumToolMaterial.a)).a(0, 8).a("hoeWood");
        M = (new ItemHoe(35, EnumToolMaterial.b)).a(1, 8).a("hoeStone");
        N = (new ItemHoe(36, EnumToolMaterial.c)).a(2, 8).a("hoeIron");
        O = (new ItemHoe(37, EnumToolMaterial.d)).a(3, 8).a("hoeDiamond");
        P = (new ItemHoe(38, EnumToolMaterial.e)).a(4, 8).a("hoeGold");
