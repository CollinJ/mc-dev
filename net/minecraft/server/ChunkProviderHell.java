...
public class ChunkProviderHell implements IChunkProvider {
    ...
    public ChunkProviderHell(World world, long l1) {
        ...
        q = new double[256];
        r = new double[256];
        s = ((MapGenBase) (new MapGenCavesHell()));
        n = world;
        h = new Random(l1);
    ...
    public void a(int i1, int j1, byte abyte0[]) {
        ...
        o = a(o, i1 * byte0, 0, j1 * byte0, k1, ((int) (byte2)), l1);
    ...
    public void b(int i1, int j1, byte abyte0[]) {
        ...
        for (int k1 = 0; k1 < 16; k1++) {
            for (int l1 = 0; l1 < 16; l1++) {
                ...
                int j2 = -1;
                byte byte1 = (byte) Block.bb.bi;
                byte byte2 = (byte) Block.bb.bi;
                ...
                for (int k2 = 127; k2 >= 0; k2--) {
                    ...
                    if (byte3 != Block.bb.bi) {
                        continue;
                    }
                    if (j2 == -1) {
                        if (i2 <= 0) {
                            byte1 = 0;
                            byte2 = (byte) Block.bb.bi;
                        } else if (k2 >= byte0 - 4 && k2 <= byte0 + 1) {
                            byte1 = (byte) Block.bb.bi;
                            byte2 = (byte) Block.bb.bi;
                            if (flag1) {
    ...
    public Chunk b(int i1, int j1) {
        ...
        a(i1, j1, abyte0);
        b(i1, j1, abyte0);
        s.a(((IChunkProvider) (this)), n, i1, j1, abyte0);
    ...
    public void a(IChunkProvider ichunkprovider, int i1, int j1) {
        ...
        for (int i2 = 0; i2 < 8; i2++) {
            ...
            (new WorldGenHellLava(Block.C.bi)).a(n, h, k2, i4, k5);
        }
        ...
        if (h.nextInt(1) == 0) {
            ...
            (new WorldGenFlowers(Block.af.bi)).a(n, h, k3, i5, k6);
        }
        if (h.nextInt(1) == 0) {
            ...
            (new WorldGenFlowers(Block.ag.bi)).a(n, h, l3, j5, l6);
        }
        BlockSand.a = false;
    }
