...
public class ChunkLoader implements IChunkLoader {
    ...
    public Chunk a(World world, int i, int j) {
        ...
        if (file != null && file.exists()) {
            try {
                ...
                NBTTagCompound nbttagcompound = CompressedStreamTools.a(((java.io.InputStream) (fileinputstream)));
                ...
                if (!chunk.a(i, j)) {
                    System.out.println((new StringBuilder()).append("Chunk file at ").append(i).append(",").append(j).append(" is in the wrong location; relocating. (Expected ").append(i).append(", ").append(j).append(", got ").append(chunk.j).append(", ").append(chunk.k).append(")").toString());
    ...
    public void a(World world, Chunk chunk) {
        ...
        try {
            ...
            CompressedStreamTools.a(nbttagcompound, ((java.io.OutputStream) (fileoutputstream)));
    ...
    public void a(Chunk chunk, World world, NBTTagCompound nbttagcompound) {
        ...
        for (Iterator iterator1 = chunk.l.values().iterator(); iterator1.hasNext(); nbttaglist1.a(((NBTBase) (nbttagcompound2)))) {
