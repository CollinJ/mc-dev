...
public class NoiseGeneratorOctaves2 extends NoiseGenerator {
    ...
    public double[] a(double ad[], double d, double d1, int i, int j, double d2, double d3, double d4) {
        return a(ad, d, d1, i, j, d2, d3, d4, 0.5D);
    }

    public double[] a(double ad[], double d, double d1, int i, int j, double d2, double d3, double d4, double d5) {
        d2 /= 1.5D;
        d3 /= 1.5D;
