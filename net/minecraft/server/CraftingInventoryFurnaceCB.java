...
public class CraftingInventoryFurnaceCB extends CraftingInventoryCB {
    ...
    public CraftingInventoryFurnaceCB(IInventory iinventory, TileEntityFurnace tileentityfurnace) {
        ...
        h = 0;
        a = tileentityfurnace;
        a(new Slot(((IInventory) (tileentityfurnace)), 0, 56, 17));
        a(new Slot(((IInventory) (tileentityfurnace)), 1, 56, 53));
        a(new Slot(((IInventory) (tileentityfurnace)), 2, 116, 35));
        for (int i = 0; i < 3; i++) {
            for (int k = 0; k < 9; k++) {
    ...
    public void a(ICrafting icrafting) {
        super.a(icrafting);
        icrafting.a(((CraftingInventoryCB) (this)), 0, a.g);
        icrafting.a(((CraftingInventoryCB) (this)), 1, a.e);
        icrafting.a(((CraftingInventoryCB) (this)), 2, a.f);
    }
